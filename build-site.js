...
function buildChatJS() {
  ...
  'var lm=text.match(/\\[LEAD[:\\{]([^\\]]*)/);if(lm){try{var ld=JSON.parse("{"+lm[1].split("{").slice(1).join("{")); notifyLead(ld);}catch(e){} text=text.replace(/\\[LEAD[^\\]]*\\]/g,"").trim();}' +
...
PAGES.push(page({
  ...
  <section class="section section-grad" style="padding-top:140px">
    <div class="container" style="max-width:560px">
      ...
      <div class="divider center"></div>
      <form style="margin-top:40px" action="https://formspree.io/f/${CONFIG.formspreeId}" method="POST">
      ...
      <p class="center" style="margin-top:20px;font-size:13px;color:var(--wgray)">Or call/text directly: ${PHONE}</p>
    </div>
  </section>
  `
}));
